...
@Entity(name = "AcceptedLogs")
public class AcceptedLog {
    ...
    public AcceptedLog(String requestId, LocalDateTime date, String request, String response, String TransactionRefrence) {
    ...
    public boolean equals(Object o) {
        ...
        AcceptedLog that = (AcceptedLog) o;
